...
public class Peer {
     ...
     * @see net.boreeas.enetty.codec.ENetChannel#sendReliable(io.netty.buffer.ByteBuf)
     */
     ...
     * @see net.boreeas.enetty.codec.ENetChannel#sendUnreliable(io.netty.buffer.ByteBuf)
     */
